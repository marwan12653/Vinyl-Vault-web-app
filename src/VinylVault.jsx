...
// 1. NESTED DATA STRUCTURE (Now includes Abbey Road and Is This It)
const GENRE_DATA = [
  {
    name: "Indie Rock",
      ...
      },
      {
        ...
        albums: [{ 
          ...
          tracks: [
            ...
            { name: "Yes I'm Changing", audio: "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-5.mp3" }
          ]
        }]
      }
    ]
  ...
  {
    name: "Classic Rock",
    image: "https://images.unsplash.com/photo-1498038432885-c6f3f1b912ee?auto=format&fit=crop&q=60&w=500",
    artists: [
      {
        name: "The Beatles",
        albums: [{ 
...
export default function VinylVault() {
  // --- STATE MANAGEMENT (Starts Empty) ---
  const [collection, setCollection] = useState([]);
  const [view, setView] = useState('player'); // Start on Genres so the user can add music
      ...
      <main className="max-w-7xl mx-auto p-6 md:p-12 relative z-10">
        <div className="grid grid-cols-1 xl:grid-cols-12 gap-12 items-start">
          ...
          <aside className="xl:col-span-3 flex flex-col gap-4">
            ...
            {collection.length === 0 ? (
              <p className="text-zinc-500 text-xs px-2 italic">Vault is empty. Add music from Genres.</p>
            ) : (
              ...
              {view === 'player' && (
                selected ? (
                  ...
                  <div className="flex flex-col items-center justify-center h-[50vh] text-zinc-600">
                    ...
                    <p>Select an album from your collection to start spinning</p>
                  </div>
                )
              )}
